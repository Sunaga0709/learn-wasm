    ...
    pub mod mynamespace {
        ...
        pub mod greet {
            ...
            pub mod greetable {
                ...
                #[doc(hidden)]
                macro_rules! __export_mynamespace_greet_greetable_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "mynamespace:greet/greetable#name"] unsafe extern "C" fn
                        export_name() -> * mut u8 { $($path_to_types)*::
                        _export_name_cabi::<$ty > () } #[export_name =
                        "cabi_post_mynamespace:greet/greetable#name"] unsafe extern "C"
                        fn _post_return_name(arg0 : * mut u8,) { $($path_to_types)*::
                        __post_return_name::<$ty > (arg0) } #[export_name =
                        "mynamespace:greet/greetable#greet"] unsafe extern "C" fn
                        export_greet(arg0 : * mut u8, arg1 : usize,) -> * mut u8 {
                        $($path_to_types)*:: _export_greet_cabi::<$ty > (arg0, arg1) }
                        #[export_name = "cabi_post_mynamespace:greet/greetable#greet"]
                        unsafe extern "C" fn _post_return_greet(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_greet::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_mynamespace_greet_greetable_cabi;
                #[repr(align(4))]
...
macro_rules! __export_greetable_provider_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::mynamespace::greet::greetable::__export_mynamespace_greet_greetable_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::mynamespace::greet::greetable);
    };
}
#[doc(inline)]
pub(crate) use __export_greetable_provider_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:mynamespace:greet:greetable-provider:encoded world"]
#[doc(hidden)]
...
\x01\x1bmynamespace:greet/greetable\x05\0\x04\x01$mynamespace:greet/greetable-pr\
ovider\x04\0\x0b\x18\x01\0\x12greetable-provider\x03\0\0\0G\x09producers\x01\x0c\
